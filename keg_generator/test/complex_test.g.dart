...
abstract class _$AppDatabaseExecutor extends DatabaseExecutor {
  ...
  /// If specified id already exists in table, update the record.
  /// If specified id does not exist in table, insert with the id.
  Future<int> registerColor(Color item);

  Future<List<Color>> queryColor({
    String? where,
    List<Object?>? whereArgs,
    String? orderBy,
    int? limit,
  ...
  Future<int> deleteColor({String? where, List<Object?>? whereArgs});

  Future<int> deleteColorByIds(List<Color> itemList);
  ...
  /// Insert or update ItemToColor.
  /// If id is 0, insert and sets id to generated value.
  /// If specified id already exists in table, update the record.
  /// If specified id does not exist in table, insert with the id.
  Future<int> registerItemToColor(ItemToColor item);

  Future<List<ItemToColor>> queryItemToColor({
    String? where,
    List<Object?>? whereArgs,
    String? orderBy,
    int? limit,
  ...
  Future<ItemToColor?> getItemToColor(
    int id, [
    List<({String table, String column})> dropKeys = const [],
  ]);

  Future<int> deleteItemToColor({String? where, List<Object?>? whereArgs});

  Future<int> deleteItemToColorByIds(List<ItemToColor> itemList);
}
...
class _$AppDatabaseTransactionWrapper implements _$AppDatabaseExecutor {
  ...
  @override
  Future<int> registerColor(Color item) =>
      appdb.colorHelper.register(item, this);
  ...
  Future<Color?> getColor(
    int id, [
    List<({String table, String column})> dropKeys = const [],
  ]) => appdb.colorHelper.get(id, this, dropKeys);

  @override
  Future<int> deleteColor({String? where, List<Object?>? whereArgs}) =>
      appdb.colorHelper.delete(this, where: where, whereArgs: whereArgs);

  @override
  Future<int> deleteColorByIds(List<Color> itemList) =>
      appdb.colorHelper.deleteByIds(this, itemList);
  ...
  @override
  Future<int> registerItemToColor(ItemToColor item) =>
      appdb.itemToColorHelper.register(item, this);
  ...
  Future<ItemToColor?> getItemToColor(
    int id, [
    List<({String table, String column})> dropKeys = const [],
  ]) => appdb.itemToColorHelper.get(id, this, dropKeys);

  @override
  Future<int> deleteItemToColor({String? where, List<Object?>? whereArgs}) =>
      appdb.itemToColorHelper.delete(this, where: where, whereArgs: whereArgs);

  @override
  Future<int> deleteItemToColorByIds(List<ItemToColor> itemList) =>
      appdb.itemToColorHelper.deleteByIds(this, itemList);
...
class _$AppDatabaseBatchWrapper implements Batch {
  ...
  void registerColor(
    ...
    appdb.colorHelper.registerBatch(item, this);
    if (onCommit != null) {
      _addCallBack(callBackIndex - 1, onCommit);
    }
  }
  ...
  void getColor(
    ...
    appdb.colorHelper.getBatch(id, this, dropKeys);
    if (onCommit != null) {
      _addCallBack(callBackIndex - 1, onCommit);
    }
  }
  ...
  void deleteColor({
    ...
    appdb.colorHelper.deleteBatch(this, where: where, whereArgs: whereArgs);
    if (onCommit != null) {
      _addCallBack(callBackIndex - 1, onCommit);
    }
  }

  void deleteColorByIds(
    List<Color> itemList, [
    Future<Object?> Function(bool? noResult, Object?)? onCommit,
  ]) {
    appdb.colorHelper.deleteByIdsBatch(this, itemList);
    if (onCommit != null) {
      _addCallBack(callBackIndex - 1, onCommit);
    }
  }
  ...
  void registerItemToColor(
    ItemToColor item, [
    Future<Object?> Function(bool? noResult, Object?)? onCommit,
  ]) {
    appdb.itemToColorHelper.registerBatch(item, this);
    if (onCommit != null) {
      _addCallBack(callBackIndex - 1, onCommit);
    }
  }

  void queryItemToColor({
    String? where,
    List<Object?>? whereArgs,
    String? orderBy,
    int? limit,
    ...
    appdb.itemToColorHelper.queryBatch(
      this,
      where: where,
      whereArgs: whereArgs,
      orderBy: orderBy,
  ...
  void getItemToColor(
    ...
    appdb.itemToColorHelper.getBatch(id, this, dropKeys);
    if (onCommit != null) {
      _addCallBack(callBackIndex - 1, onCommit);
    }
  }

  void deleteItemToColor({
    String? where,
    List<Object?>? whereArgs,
    Future<Object?> Function(bool? noResult, Object?)? onCommit,
  }) {
    appdb.itemToColorHelper.deleteBatch(
      this,
      where: where,
      whereArgs: whereArgs,
    );
  ...
  void deleteItemToColorByIds(
    List<ItemToColor> itemList, [
    Future<Object?> Function(bool? noResult, Object?)? onCommit,
  ]) {
    appdb.itemToColorHelper.deleteByIdsBatch(this, itemList);
    if (onCommit != null) {
      _addCallBack(callBackIndex - 1, onCommit);
    }
  }
...
abstract class _$AppDatabase implements _$AppDatabaseExecutor {
  ...
  late final colorHelper = _$ColorHelper(this);
  late final orderToItemHelper = _$OrderToItemHelper(this);
  late final itemToColorHelper = _$ItemToColorHelper(this);
  ...
  Future<void> onCreate(Database db, int version) async {
    ...
    await colorHelper.onCreate(version, batch: batch);
    await orderToItemHelper.onCreate(version, batch: batch);
    await itemToColorHelper.onCreate(version, batch: batch);
    await batch.commit();
  }
  ...
  Future<void> onUpgrade(Database db, int oldVersion, int newVersion) async {
    ...
    await colorHelper.onUpgrade(oldVersion, newVersion, batch: batch);
    await orderToItemHelper.onUpgrade(oldVersion, newVersion, batch: batch);
    await itemToColorHelper.onUpgrade(oldVersion, newVersion, batch: batch);
    await batch.commit();
  }
  ...
  /// If specified id does not exist in table, insert with the id.
  @override
  Future<int> registerColor(Color item) => colorHelper.register(item, this);
  ...
  Future<Color?> getColor(
    int id, [
    List<({String table, String column})> dropKeys = const [],
  ]) => colorHelper.get(id, this, dropKeys);

  @override
  Future<int> deleteColor({String? where, List<Object?>? whereArgs}) =>
      colorHelper.delete(this, where: where, whereArgs: whereArgs);

  @override
  Future<int> deleteColorByIds(List<Color> itemsList) =>
      colorHelper.deleteByIds(this, itemsList);
  ...
  @override
  Future<int> registerItemToColor(ItemToColor item) =>
      itemToColorHelper.register(item, this);
  ...
  Future<ItemToColor?> getItemToColor(
    int id, [
    List<({String table, String column})> dropKeys = const [],
  ]) => itemToColorHelper.get(id, this, dropKeys);

  @override
  Future<int> deleteItemToColor({String? where, List<Object?>? whereArgs}) =>
      itemToColorHelper.delete(this, where: where, whereArgs: whereArgs);

  @override
  Future<int> deleteItemToColorByIds(List<ItemToColor> itemsList) =>
      itemToColorHelper.deleteByIds(this, itemsList);
...
class _$OrderHelper {
  ...
  final column = (id: '"id"', user: '"user_id"');
  final columnTypes = {
    'id': 'INTEGER PRIMARY KEY AUTOINCREMENT',
    'user_id': 'INTEGER REFERENCES "user"("id")',
  };
  final columnList = ['id', 'user_id'];

  _$AppDatabase appdb;

  _$OrderHelper(this.appdb);

  static final v1ColumnList = ['id', 'user_id'];
  final columnListByVersion = {1: v1ColumnList};
  ...
  static Order fromSqlMap(Map<String, Object?> map) {
    ...
    if (keys.contains('cancelled_item_list')) {
      params['cancelledItemList'] = map['cancelled_item_list'] as List<Item>;
      keys.remove('cancelled_item_list');
    }
  ...
  bool compareCancelledItemList(Order item1, Set<int> set2) {
    if (item1.cancelledItemList.length != set2.length) {
      return false;
    }
    final list1 = item1.cancelledItemList.map((e) => e.id).toList();
    for (final item in list1) {
      if (!set2.contains(item)) {
        return false;
      }
  ...
  Future<void> registerCancelledItemList(
    Order item,
    _$AppDatabaseExecutor executor,
  ) async {
    final batch = executor.batch();
    for (final target in item.cancelledItemList) {
      Map<String, Object?> middleMap = {};
      middleMap[appdb.orderToItemHelper.column.order] = item;
      middleMap[appdb.orderToItemHelper.column.item] = target;
      middleMap[appdb.orderToItemHelper.column.field] = 'cancelledItemList';
      final middle = OrderToItem.fromSqlMap(middleMap);
      batch.registerOrderToItem(middle);
    }
    await batch.commit();
  ...
  Future<int> register(Order item, _$AppDatabaseExecutor db) async {
    ...
    final cancelledItemListNoids = item.cancelledItemList.where(
      (e) => e.id == 0,
    );
    if (cancelledItemListNoids.isNotEmpty) {
      throw ArgumentError(
        'Cannot register Order because cancelledItemList has unregistered items.',
      );
    }
    if (item.cancelledItemList.length !=
        item.cancelledItemList.toSet().length) {
      throw ArgumentError(
        'Cannot register Order because cancelledItemList has duplicate items.',
      );
    }
    final map = item.toSqlMap();
    var command = 'REPLACE INTO';
    ...
    // handle many to many relation for cancelledItemList
    bool addCancelledItemList = true;
    if (originalId != 0) {
      // compare existing middle records
      final existingMiddleList = await executor.query(
        appdb.orderToItemHelper.tableName,
        where:
            '${appdb.orderToItemHelper.column.order} = ? AND ${appdb.orderToItemHelper.column.field} = ?',
        whereArgs: [originalId, 'cancelledItemList'],
      );
      final existingTargetIds = existingMiddleList
          .where((e) => e[appdb.orderToItemHelper.column.item] != null)
          .map((e) => e[appdb.orderToItemHelper.column.item] as int)
          .toSet();
      if (!compareCancelledItemList(item, existingTargetIds)) {
        // delete middle records
        await executor.deleteOrderToItem(
          where:
              '${appdb.orderToItemHelper.column.order} = ? AND ${appdb.orderToItemHelper.column.field} = ?',
        ...
        addCancelledItemList = false;
      }
    }
    if (addCancelledItemList) {
      // register middle records
      await registerCancelledItemList(item, executor);
    }
  ...
  Future<List<Map<String, Object?>>> convertReferences(
    ...
    final cancelledItemListColumnList = <String>[];
    for (final col in appdb.orderToItemHelper.columnList) {
      cancelledItemListColumnList.add(
        '${appdb.orderToItemHelper.tableName}."$col" as "${_unquote(appdb.orderToItemHelper.tableName)}-$col"',
      );
    }
    for (final col in appdb.itemHelper.columnList) {
    ...
    final cancelledItemListSql =
        '''SELECT ${cancelledItemListColumnList.join(', ')} 
        FROM ${appdb.orderToItemHelper.tableName} 
        INNER JOIN ${appdb.itemHelper.tableName} 
        ON ${appdb.orderToItemHelper.tableName}.${appdb.orderToItemHelper.column.item} = 
        ${appdb.itemHelper.tableName}."id" 
        WHERE ${appdb.orderToItemHelper.tableName}.${appdb.orderToItemHelper.column.order} = ? 
        AND ${appdb.orderToItemHelper.tableName}.${appdb.orderToItemHelper.column.field} ='cancelledItemList' 
        ORDER BY ${appdb.itemHelper.tableName}.${appdb.itemHelper.column.name} ASC''';
    ...
    for (var i = 0; i < result.length; i++) {
      ...
      if (dropKeys
          .where(
            (e) =>
                _unquote(e.table) == 'order' &&
                e.column == 'cancelled_item_list',
          )
          .isEmpty) {
        batch.rawQuery(cancelledItemListSql, [id], (noResult, object) async {
          if (noResult == true || object is! List<Map<String, Object?>>) {
            throw StateError('returned object $object is not expected type.');
          }
          final middleList = object;
          ...
          final targetList = targetMapList
              .map((targetMap) => Item.fromSqlMap(targetMap))
              .toList();
          map['cancelled_item_list'] = targetList;
          return targetList;
        });
      }
    }
  ...
  Future<int> deleteByIds(
    ...
    // delete many to many middle records for cancelledItemList
    await db.deleteOrderToItem(
      where:
          '${appdb.orderToItemHelper.column.order} in (${List.filled(ids.length, '?').join(',')})',
      whereArgs: ids,
...
class _$ColorHelper {
  ...
  Future<void> onCreate(
    ...
    if (columnList.isEmpty) {
      throw UnsupportedError("No columns defined for Color version $version");
    }
    var params = [];
    for (final column in columnList) {
      params.add('"$column" ${columnTypes[column]}');
  ...
  static Map<String, Object?> toSqlMap(Color item) {
    final values = <String, Object?>{};
  ...
  static Color fromSqlMap(Map<String, Object?> map) {
    map = _unquoteMap(map);
    final keys = map.keys.toSet();
    final params = <String, Object>{};
    if (!keys.contains('name')) {
  ...
  Future<int> register(Color item, _$AppDatabaseExecutor db) async {
    final map = item.toSqlMap();
    var command = 'REPLACE INTO';
    final originalId = item.id;
    if (originalId == 0) {
  ...
  void registerBatch(Color item, _$AppDatabaseBatchWrapper batch) {
    final map = item.toSqlMap();
    var command = 'REPLACE INTO';
    final originalId = item.id;
    if (originalId == 0) {
  ...
  Future<List<Map<String, Object?>>> convertReferences(
    ...
    final itemListColumnList = <String>[];
    for (final col in appdb.itemToColorHelper.columnList) {
      itemListColumnList.add(
        '${appdb.itemToColorHelper.tableName}."$col" as "${_unquote(appdb.itemToColorHelper.tableName)}-$col"',
      );
    }
    for (final col in appdb.itemHelper.columnList) {
      itemListColumnList.add(
    ...
    final itemListSql =
        '''SELECT ${itemListColumnList.join(', ')} 
        FROM ${appdb.itemToColorHelper.tableName} 
        INNER JOIN ${appdb.itemHelper.tableName} 
        ON ${appdb.itemToColorHelper.tableName}.${appdb.itemToColorHelper.column.item} = 
        ${appdb.itemHelper.tableName}."id" 
        WHERE ${appdb.itemToColorHelper.tableName}.${appdb.itemToColorHelper.column.color} = ? 
        AND ${appdb.itemToColorHelper.tableName}.${appdb.itemToColorHelper.column.field} ='colorList' 
        ORDER BY ${appdb.itemHelper.tableName}.${appdb.itemHelper.column.id} ASC''';
    ...
    for (var i = 0; i < result.length; i++) {
      ...
      // ignore: unused_local_variable
      final id = map['id'] as int;
      //print('Color($id) ${dropKeys.map((e) => '${_unquote(e.table)}.${_unquote(e.column)}').join(', ')}');
      for (final key in dropKeys) {
        if (_unquote(key.table) == 'color') {
          map.remove(_unquote(key.column));
        }
      }
      if (dropKeys
          .where((e) => _unquote(e.table) == 'color' && e.column == 'item_list')
          .isEmpty) {
        batch.rawQuery(itemListSql, [id], (noResult, object) async {
          if (noResult == true || object is! List<Map<String, Object?>>) {
            throw StateError('returned object $object is not expected type.');
          ...
          targetMapList = await appdb.itemHelper.convertReferences(
            ...
            [
              ...dropKeys,
              (table: appdb.itemHelper.tableName, column: 'color_list'),
            ],
          );
          final targetList = targetMapList
              .map((targetMap) => Item.fromSqlMap(targetMap))
  ...
  /// convert map list from sql query to object list
  List<Color> mapToObject(List<Map<String, Object?>> mapList) {
    final result = mapList.map((map) => Color.fromSqlMap(map)).toList();
    return result;
  }

  Future<List<Color>> query(
    _$AppDatabaseExecutor db, {
    String? where,
    List<Object?>? whereArgs,
    String? orderBy,
  ...
  Future<int> deleteByIds(
    ...
    final noids = itemList.where((e) => e.id == 0);
    if (noids.isNotEmpty) {
      throw ArgumentError('Cannot delete Color because id is 0.');
    }
    final ids = itemList.map((e) => e.id).toSet().toList();
  ...
  void deleteByIdsBatch(_$AppDatabaseBatchWrapper batch, List<Color> itemList) {
    final noids = itemList.where((e) => e.id == 0);
    if (noids.isNotEmpty) {
      throw ArgumentError('Cannot delete Color because id is 0.');
    }
...
class _$ItemHelper {
  ...
  static Item fromSqlMap(Map<String, Object?> map) {
    ...
    if (keys.contains('color_list')) {
      params['colorList'] = map['color_list'] as List<Color>;
      keys.remove('color_list');
    }
    ...
    if (params['colorList'] != null) {
      $item.colorList = params['colorList'] as List<Color>;
    }
    if (params['orderList'] != null) {
      $item.orderList = params['orderList'] as List<Order>;
    }
  ...
  bool compareColorList(Item item1, Set<int> set2) {
    if (item1.colorList.length != set2.length) {
      return false;
    }
    final list1 = item1.colorList.map((e) => e.id).toList();
    for (final item in list1) {
      if (!set2.contains(item)) {
        return false;
      }
  ...
  Future<void> registerColorList(
    Item item,
    _$AppDatabaseExecutor executor,
  ) async {
    final batch = executor.batch();
    for (final target in item.colorList) {
      Map<String, Object?> middleMap = {};
      middleMap[appdb.itemToColorHelper.column.item] = item;
      middleMap[appdb.itemToColorHelper.column.color] = target;
      middleMap[appdb.itemToColorHelper.column.field] = 'colorList';
      final middle = ItemToColor.fromSqlMap(middleMap);
      batch.registerItemToColor(middle);
    }
    await batch.commit();
  }

  Future<int> register(Item item, _$AppDatabaseExecutor db) async {
    final colorListNoids = item.colorList.where((e) => e.id == 0);
    if (colorListNoids.isNotEmpty) {
      throw ArgumentError(
        'Cannot register Item because colorList has unregistered items.',
      );
    }
    if (item.colorList.length != item.colorList.toSet().length) {
      throw ArgumentError(
        'Cannot register Item because colorList has duplicate items.',
      );
    }
    final map = item.toSqlMap();
    var command = 'REPLACE INTO';
    ...
    bool addColorList = true;
    if (originalId != 0) {
      // compare existing middle records
      final existingMiddleList = await executor.query(
        appdb.itemToColorHelper.tableName,
        where:
            '${appdb.itemToColorHelper.column.item} = ? AND ${appdb.itemToColorHelper.column.field} = ?',
        whereArgs: [originalId, 'colorList'],
      );
      final existingTargetIds = existingMiddleList
          .where((e) => e[appdb.itemToColorHelper.column.color] != null)
          .map((e) => e[appdb.itemToColorHelper.column.color] as int)
          .toSet();
      if (!compareColorList(item, existingTargetIds)) {
        // delete middle records
        await executor.deleteItemToColor(
          where:
              '${appdb.itemToColorHelper.column.item} = ? AND ${appdb.itemToColorHelper.column.field} = ?',
          whereArgs: [originalId, 'colorList'],
        );
    ...
    if (addColorList) {
      // register middle records
      await registerColorList(item, executor);
    }
  ...
  Future<List<Map<String, Object?>>> convertReferences(
    ...
    final colorListColumnList = <String>[];
    for (final col in appdb.itemToColorHelper.columnList) {
      colorListColumnList.add(
        '${appdb.itemToColorHelper.tableName}."$col" as "${_unquote(appdb.itemToColorHelper.tableName)}-$col"',
      );
    }
    for (final col in appdb.colorHelper.columnList) {
      colorListColumnList.add(
        '${appdb.colorHelper.tableName}."$col" as "${_unquote(appdb.colorHelper.tableName)}-$col"',
      );
    }
    final colorListSql =
        '''SELECT ${colorListColumnList.join(', ')} 
        FROM ${appdb.itemToColorHelper.tableName} 
        INNER JOIN ${appdb.colorHelper.tableName} 
        ON ${appdb.itemToColorHelper.tableName}.${appdb.itemToColorHelper.column.color} = 
        ${appdb.colorHelper.tableName}."id" 
        WHERE ${appdb.itemToColorHelper.tableName}.${appdb.itemToColorHelper.column.item} = ? 
        AND ${appdb.itemToColorHelper.tableName}.${appdb.itemToColorHelper.column.field} ='colorList' 
        ORDER BY ${appdb.colorHelper.tableName}.${appdb.colorHelper.column.id} ASC''';
    ...
    for (var i = 0; i < result.length; i++) {
      ...
      if (dropKeys
          .where((e) => _unquote(e.table) == 'item' && e.column == 'color_list')
          .isEmpty) {
        batch.rawQuery(colorListSql, [id], (noResult, object) async {
          if (noResult == true || object is! List<Map<String, Object?>>) {
            throw StateError('returned object $object is not expected type.');
          }
          final middleList = object;
          ...
          for (final middleMap in middleList) {
            final targetMap = <String, Object?>{};
            for (final key in middleMap.keys) {
              if (key.startsWith('${_unquote(appdb.colorHelper.tableName)}-')) {
                final newKey = key.substring(
                  _unquote(appdb.colorHelper.tableName).length + 1,
                );
                targetMap[newKey] = middleMap[key];
              }
            }
          ...
          targetMapList = await appdb.colorHelper.convertReferences(
            targetMapList,
            db,
            [
              ...dropKeys,
              (table: appdb.colorHelper.tableName, column: 'item_list'),
            ],
          );
          final targetList = targetMapList
              .map((targetMap) => Color.fromSqlMap(targetMap))
              .toList();
          map['color_list'] = targetList;
          return targetList;
        });
      }
  ...
  Future<int> delete(
    ...
    // delete many to many middle records
    await db.deleteItemToColor(
      where:
          '${appdb.itemToColorHelper.column.item} in (SELECT id FROM $tableName  ${where != null ? ' WHERE $where' : ''})',
      whereArgs: whereArgs,
    );
    return db.delete(tableName, where: where, whereArgs: whereArgs);
  }
  ...
  Future<int> deleteByIds(_$AppDatabaseExecutor db, List<Item> itemList) async {
    ...
    // delete many to many middle records for colorList
    await db.deleteItemToColor(
      where:
          '${appdb.itemToColorHelper.column.item} in (${List.filled(ids.length, '?').join(',')})',
      whereArgs: ids,
    );
...
class _$ItemToColorHelper {
  final String tableName = '"item_to_color"';
  final column = (
    id: '"id"',
    item: '"item_id"',
    color: '"color_id"',
  ...
  final columnList = ['id', 'item_id', 'color_id', 'field'];

  _$AppDatabase appdb;

  _$ItemToColorHelper(this.appdb);

  static final v1ColumnList = ['id', 'item_id', 'color_id', 'field'];
  final columnListByVersion = {1: v1ColumnList};
  ...
  Future<void> onCreate(
    ...
    if (columnList.isEmpty) {
      throw UnsupportedError(
        "No columns defined for ItemToColor version $version",
      );
    }
    var params = [];
    for (final column in columnList) {
  ...
  static Map<String, Object?> toSqlMap(ItemToColor item) {
    final values = <String, Object?>{};
    ...
    if (item.item != null) {
      ...
      if (itemId != 0) {
        ...
        throw StateError('ItemToColor.item.id is 0.');
      }
    }

    if (item.color != null) {
      final colorId = item.color!.id;
      if (colorId != 0) {
        values['color_id'] = colorId;
      } else {
        throw StateError('ItemToColor.color.id is 0.');
      }
    }
  ...
  static ItemToColor fromSqlMap(Map<String, Object?> map) {
    map = _unquoteMap(map);
    final keys = map.keys.toSet();
    if (!keys.contains('field')) {
      throw ArgumentError("Missing required key field in map");
    ...
    Color? color;
    if (keys.contains('color_id')) {
      color = map['color_id'] as Color?;
      keys.remove('color_id');
    }
    ...
    final $item = ItemToColor(id: id, item: item, color: color, field: field);

    return $item;
  }

  Future<int> register(ItemToColor item, _$AppDatabaseExecutor db) async {
    final map = item.toSqlMap();
    var command = 'REPLACE INTO';
    final originalId = item.id;
    if (originalId == 0) {
  ...
  void registerBatch(ItemToColor item, _$AppDatabaseBatchWrapper batch) {
    final map = item.toSqlMap();
    var command = 'REPLACE INTO';
    final originalId = item.id;
    if (originalId == 0) {
  ...
  Future<List<Map<String, Object?>>> convertReferences(
    ...
    for (var i = 0; i < result.length; i++) {
      ...
      // ignore: unused_local_variable
      final id = map['id'] as int;
      //print('ItemToColor($id) ${dropKeys.map((e) => '${_unquote(e.table)}.${_unquote(e.column)}').join(', ')}');
      for (final key in dropKeys) {
        if (_unquote(key.table) == 'item_to_color') {
          map.remove(_unquote(key.column));
        }
      }
      final itemId = map['item_id'] as int?;
      ...
      final colorId = map['color_id'] as int?;
      if (colorId != null) {
        batch.getColor(
          colorId,
          dropKeys: dropKeys,
  ...
  /// convert map list from sql query to object list
  List<ItemToColor> mapToObject(List<Map<String, Object?>> mapList) {
    final result = mapList.map((map) => ItemToColor.fromSqlMap(map)).toList();
    return result;
  }

  Future<List<ItemToColor>> query(
    _$AppDatabaseExecutor db, {
    String? where,
    List<Object?>? whereArgs,
    String? orderBy,
  ...
  Future<int> deleteByIds(
    ...
    final noids = itemList.where((e) => e.id == 0);
    if (noids.isNotEmpty) {
      throw ArgumentError('Cannot delete ItemToColor because id is 0.');
    }
    final ids = itemList.map((e) => e.id).toSet().toList();
